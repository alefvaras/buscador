...
== Changelog ==
= Version 4.18.0 - Released on 24 June 2025 =
 * New: support for WooCommerce 10.0
 * Fix: conflict with WooCommerce PDF Product Vouchers (by SkyVerge)
 * Fix: variable selection error on product single page
 * New: added woocommerce email preview support
 * New: added filter ywpar_is_valid_for_product_force
 * Update: YITH plugin framework

= Version 4.17.0 - Released on 14 May 2025 =
 * New: support for WooCommerce 9.9
 * New: minor change to load script in the footer
 * Update: YITH plugin framework

= Version 4.16.0 - Released on 16 April 2025 =
