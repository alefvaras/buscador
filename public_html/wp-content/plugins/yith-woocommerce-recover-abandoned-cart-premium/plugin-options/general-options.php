...
$settings = array(
	...
	'general' => array(
		...
		'section_general_settings'         => array(
			'name' => esc_html__( 'General', 'yith-woocommerce-recover-abandoned-cart' ),
			'type' => 'title',
		...
		'cut_off_time'                     => array(
			...
			'desc'      => esc_html__( 'Choose when a cart can be considered as "abandoned"', 'yith-woocommerce-recover-abandoned-cart' ),
...
Personal Data collected: email address, first name, last name and phone number.',
		...
		'section_extra_settings'           => array(
			'name' => esc_html__( 'Extra settings', 'yith-woocommerce-recover-abandoned-cart' ),
			'desc' => '',
			'type' => 'title',
			'id'   => 'ywrac_section_extra',
		),
		...
		'section_extra_settings_end_form'  => array(
			'type' => 'sectionend',
			'id'   => 'ywrac_section_extra_end_form',
		),
...
/**
 * APPLY_FILTERS: yith_ywrac_panel_settings_options
 *
