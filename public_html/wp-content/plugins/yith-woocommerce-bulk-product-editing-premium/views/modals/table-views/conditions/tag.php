<?php
/**
 * Table views modal - Tag condition template
 *
...
<div class="yith-wcbep-table-view-tag-condition">
	<?php
	$compare_field = array(
		'class'   => 'wc-enhanced-select yith-wcbep-table-view-tag-condition__compare',
		'type'    => 'select',
		'options' => array(
	...
	$select_field = array(
		'class'    => 'yith-wcbep-table-view-tag-condition__value yith-term-search',
		'type'     => 'ajax-terms',
		'data'     => array(
