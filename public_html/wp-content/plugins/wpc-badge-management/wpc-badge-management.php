...
! defined( 'WPCBM_VERSION' ) && define( 'WPCBM_VERSION', '3.1.3' );
                    ...
                    <div class="wpclever_settings_page wrap">
                        <div class="wpclever_settings_page_header">
                            ...
                            <div class="wpclever_settings_page_header_text">
                                <div class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Badge Management', 'wpc-badge-management' ) . ' ' . esc_html( WPCBM_VERSION ) . ' ' . ( defined( 'WPCBM_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-badge-management' ) . '</span>' : '' ); ?></div>
