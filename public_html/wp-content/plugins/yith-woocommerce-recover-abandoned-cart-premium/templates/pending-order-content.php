			...
			<tr class="cart_item">
				<td class="product-thumbnail">
					...
					if ( has_post_thumbnail( $product_id ) ) {
						...
						$image                        = $src;
					} elseif ( isset( $order_item['variation_id'] ) && $order_item['variation_id'] && has_post_thumbnail( $order_item['product_id'] ) ) {
						$product_image                = wp_get_attachment_image_src( get_post_thumbnail_id( $order_item['product_id'] ), 'shop_thumbnail' );
						list( $src, $width, $height ) = $product_image;
						$image                        = $src;
