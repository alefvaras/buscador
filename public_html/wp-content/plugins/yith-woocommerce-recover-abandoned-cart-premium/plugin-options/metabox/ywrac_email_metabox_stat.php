...
return array(
	'label'    => '&nbsp;',
	'class'    => yith_set_wrapper_class() . ' ywrac_metabox ywrac_metabox_stats',
	'pages'    => 'ywrac_email',
	'context'  => 'normal',
	'priority' => 'default',
	'tabs'     => array(
		...
		'stats' => array(
			...
			/**
			 * APPLY_FILTERS: ywrac_email_metabox_stat
			 *
			 * Template email stats.
			 *
			 * @param array $fields
			 */
			'fields' => apply_filters(
				...
				array(
					...
					'section_start'         => array(
						'desc' => __( 'Email Report', 'yith-woocommerce-recover-abandoned-cart' ),
						'type' => 'title',
