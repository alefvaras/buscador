...
if ( 'yes' === $allow_templates || 'yes' === $allow_customer_images ) : ?>
	<h3 class="ywgc_choose_design_title" style="<?php echo esc_attr( $display ); ?>" ><?php echo wp_kses_post( get_option( 'ywgc_choose_design_title', __( 'Choose your image', 'yith-woocommerce-gift-cards' ) ) ); ?></h3>
	...
	<div class="gift-card-content-editor step-appearance">
		...
		<?php if ( 'yes' === $allow_customer_images ) : ?>
			<p class="ywgc-custom-design-link"> <?php echo esc_html__( 'Or ', 'yith-woocommerce-gift-cards' ); ?> <a href="#" class="ywgc-choose-image ywgc-custom-picture"><?php echo esc_html__( 'Upload your image >', 'yith-woocommerce-gift-cards' ); ?></a></p>
