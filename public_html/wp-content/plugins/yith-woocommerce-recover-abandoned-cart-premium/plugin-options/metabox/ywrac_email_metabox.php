...
return array(
	'label'    => '&nbsp;',
	'class'    => yith_set_wrapper_class() . ' ywrac_metabox',
	'pages'    => 'ywrac_email',
	'context'  => 'normal',
	'priority' => 'default',
	'tabs'     => array(
		...
		'settings' => array(
			...
			'fields' => apply_filters(
				/**
				 * APPLY_FILTERS: ywrac_email_metabox
				 *
				 * Email template metabox fields.
				 *
				 * @param array $fields
				 */
				'ywrac_email_metabox',
				array(
					'section_start_general' => array(
						'desc' => __( 'General settings', 'yith-woocommerce-recover-abandoned-cart' ),
						'type' => 'title',
						'id'   => 'ywdrac_section_start_genral',
					),

					'ywrac_template_title'   => array(
						'label'    => esc_html__( 'Template name', 'yith-woocommerce-recover-abandoned-cart' ),
						'desc'     => esc_html__( 'Enter a name to identify this template', 'yith-woocommerce-recover-abandoned-cart' ),
						'custom_attributes' => array(
							'placeholder' => _x( 'Add name', 'placeholder for new post name', 'yith-woocommerce-recover-abandoned-cart' ),
						),
						'type'     => 'text',
						'std'      => '',
						'required' => true,
					...
					'ywrac_template_content'      => array(
						'label'   => __( 'Email content', 'yith-woocommerce-recover-abandoned-cart' ),
						'type'    => 'textarea-editor',
						'wpautop' => true,
						'desc'    => __( 'Click on the "y" icon in the editor to insert placeholders such as customer name, cart content, etc.', 'yith-woocommerce-recover-abandoned-cart' ),
					),

					'section_start' => array(
						'desc' => __( 'Email settings', 'yith-woocommerce-recover-abandoned-cart' ),
						'type' => 'title',
						'id'   => 'ywdrac_section_start',
					),
					...
					'ywrac_coupon_title_section_start' => array(
						'desc' => __( 'Coupon', 'yith-woocommerce-recover-abandoned-cart' ),
						'type' => 'title',
						'id'   => 'ywdrac_section_start',
					),
						...
						'fields' => array(
							...
							'type'   => array(
								...
								'options'           => array(
									...
									'fixed_cart' => sprintf( esc_html__( '%s - Fixed', 'yith-woocommerce-recover-abandoned-cart' ), get_woocommerce_currency_symbol( get_woocommerce_currency() ) ),
								),
