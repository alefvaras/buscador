...
$fields = array(
	'action'                   => array(
		'type'    => 'select',
		'id'      => 'yith-wcbep-bulk-editing-text-editor-' . $id . '-action',
	...
	'text-editor'              => array(
		'type'  => 'textarea',
		'class' => 'yith-wcbep-bulk-editing-text-editor',
	),
	'replace-text-editor-with' => array(
		'type'  => 'textarea',
		'class' => 'yith-wcbep-bulk-editing-replace-text-editor-with',
	),
);
...
<span class="yith-wcbep-bulk-editing-text-editor-container yith-wcbep-bulk-editing-first-value-container">
	<?php yith_plugin_fw_get_field( $fields['text-editor'], true, false ); ?>
</span>
<div class="yith-wcbep-bulk-editing-replace-text-editor-with-container">
	<?php echo esc_html_x( 'with', 'Bulk editing - replacing', 'yith-woocommerce-bulk-product-editing' ); ?>
	<?php yith_plugin_fw_get_field( $fields['replace-text-editor-with'], true, false ); ?>
</div>
