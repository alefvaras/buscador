	...
	class YITH_WC_Recover_Abandoned_Cart_Privacy {
		...
		public static function data_eraser( $email_address, $page ) {
			...
			if ( $carts ) {
				foreach ( $carts as $cart ) {
					/**
					 * APPLY_FILTERS: ywrac_privacy_erase_personal_data
					 *
		...
		protected static function get_cart_personal_data( $cart_post ) {
			$personal_data = array();
			/**
			 * APPLY_FILTERS: ywrac_privacy_export_personal_data_props
			 *
			 * Privacy export personal data props.
			 *
			 * @param array $props
			 * @param WP_Post $cart_post
			 */
			...
			foreach ( $props_to_export as $prop => $name ) {
				...
				/**
				 * APPLY_FILTERS: ywrac_privacy_export_personal_data_prop
				 *
				 * Privacy export personal data prop.
				 *
				 * @param mixed $value
				 * @param mixed $prop
				 * @param WP_Post $cart_post
